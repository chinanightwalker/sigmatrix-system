...
<html>
	...
	-->
		...
		<link href="${ctx}css/business/prize/timingRed.css" rel="stylesheet" type="text/css" />
		...
		<script type="text/javascript" src="${ctx}js/business/prize/timingRed.js"></script>
		<script type="text/javascript" src="${ctx}js/My97DatePicker/WdatePicker.js"></script>
	</head>

	<body>
	  <form action="${ctx}prize/saveOrUpdate" method="post" id="tk">
	  	<!-- 1代表新增,2代表修改 -->
						...
						<tr>
						    <td rowspan="4" style="width: 25%;text-align: center;">
						    	<c:if test="${activityPrizeVo.activityPrize.prizePicUrl==null||''==activityPrizeVo.activityPrize.prizePicUrl}">
							    	<img id="view_image" src="${ctx}images/activity/am_prize_006.png" style="vertical-align: middle;width: 80%;"/>
						    	</c:if>
						    	<c:if test="${activityPrizeVo.activityPrize.prizePicUrl!=null&&''!=activityPrizeVo.activityPrize.prizePicUrl}">
						    ...
						    <td style="padding: 5px 0px;">
						    	奖项名称：<input maxlength="20" name="activityPrize.prizeName" id="tk_prizeName" type="text" style="color: #ff9650;" value="${activityPrizeVo.activityPrize.prizeName}" ><span style="color: #f91142;">*</span>
						    </td>
						</tr>
						<tr>
						    <td style="padding: 5px 0px;">
						    	奖品：<span id="huafei_prizeName">定时红包</span>
						    </td>
						</tr>
				...
				<div class="gudingshu_div" style="width: 90%;margin: 0px auto;border: 1px #dcdadb solid;font-size: 12px;">
				    ...
				    <div style="width: 100%;border-bottom: 1px #dcdadb solid;padding: 10px 0px;">
				      ...
				      <div style="clear: both;"></div>
				        <textarea rows="5" cols="60" id="tk_prizeDesc" name="activityPrize.prizeDesc">${activityPrizeVo.activityPrize.prizeDesc}</textarea>
				    </div>
				</div>
					...
					<table style="width: 100%;">
						<tbody><tr>
							...
							<td style="text-align: right;">
								<input id="timingRedBtn" type="button" value="确定" onclick="saveTimingRedInfo()" style="width: 80px;text-align: center;height:28px;line-height: 28px;cursor: pointer;">
							</td>
						</tr>
					</tbody></table>
