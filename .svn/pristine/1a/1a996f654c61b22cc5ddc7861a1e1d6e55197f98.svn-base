...
<script type="text/javascript">
	...
	function navTabAjaxDone(json) {
		if (json.statusCode == DWZ.statusCode.error) {
			...
			navTab
					.openTabLs(json.navTabId, '${ctx}' + json.forwardUrl,
							" 产品管理");
...
<body>
	<div class="pageContent">
		<form method="post" action="${ctx}product/saveProduct"
			...
			<input name="productBase.productId" type="hidden"
				value="${productBase.productId}" />
			<div class="pageFormContent" layoutH="56">
				<p style="width: 100%;">
					<label>产品ID：</label> ${productBase.productId}
				</p>
				<p style="width: 100%;">
