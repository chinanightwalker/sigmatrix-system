	...
	r.fn.qrcode = function (h) {
		...
		return this.each(function () {
			...
			if ("canvas" == h.render) {
				...
				a.addData(h.text);
				a.make();
				c = r("<table></table>").css("width", h.width + "px").css("margin", "0px auto").css("height", h.height + "px").css("border", "none").css("border-collapse", "collapse").css("background-color", h.background);
				d = h.width / a.getModuleCount();
				b = h.height / a.getModuleCount();
				for (e = 0; e < a.getModuleCount(); e++) {
					f = r("<tr></tr>").css("height", b + "px").css("border", "none").appendTo(c);
					for (i = 0; i < a.getModuleCount(); i++) {
						r("<td></td>").css("width", d + "px").css("border", "none").css("background-color", a.isDark(e, i) ? h.foreground : h.background).appendTo(f);
					}
				}
			}
			a = c;
